...
# New version 
python3 main.py -t False -p result/autoscout_data_1.csv -bp ac-vehicle-data -bt autoscout24.test -400 result/models_more_400.csv -fc result/failed_cars.csv -l test.log
