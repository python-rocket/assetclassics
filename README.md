...
# New version 
python3 main.py -a True -t True -p result/autoscout_data_1.csv -bp python-rocket-1 -bt assetsclassics_eu.test -400 result/models_more_400.csv -fc result/failed_cars.csv -l test.log
